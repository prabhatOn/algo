...
export const ProductProvider = ({ children }) => {
    ...
    const { data: productsData, isLoading: isProductsLoading, error: productsError } = useSWR('/api/data/eCommerce/ProductsData', );
    ...
    // Fetch products data from the API 
    const { data: cartsData, isLoading: isCartsLoading, error: cartsError, mutate: cartMutate } = useSWR('/api/eCommerce/carts', );

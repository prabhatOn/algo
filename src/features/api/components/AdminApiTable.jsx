...
import AddApiDialog from '../../users/components/AddApiDialog';
...
const rowsData = [
  ...
  { id: 4, name: 'CoinDCX API', broker: 'CoinDCX',brokerId:'292', autologin: false, status: 'Active', segment: 'Crypto' },
      { id: 5, name: 'Zerodha API', broker: 'Zerodha', brokerId: '232', autologin: true, status: 'Active', segment: 'Indian' },
  { id: 6, name: 'Binance API', broker: 'Binance', brokerId: '262', autologin: false, status: 'Inactive', segment: 'Crypto' },
  { id: 7, name: 'Upstox API', broker: 'Upstox', brokerId: '272', autologin: true, status: 'Pending', segment: 'Indian' },
  { id: 8, name: 'CoinDCX API', broker: 'CoinDCX', brokerId: '292', autologin: false, status: 'Active', segment: 'Crypto' },
];
